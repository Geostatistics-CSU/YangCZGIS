    ...
    ui(new Ui::YangCZFServiceDialog)
{
    ...
    connect(ui->btnBrowseOutput, &QPushButton::clicked, this, &YangCZFServiceDialog::onBtnBrowseOutputClicked);
}
...
void YangCZFServiceDialog::onBtnConfirmClicked()
{
    ...
    QString savepath = ui->lineOutputPath->text();
    ...
    if (run_code) {
        ...
        emit sendPyParams(obPt_val, obPts_c, times, dim, savepath);
    }
}

void YangCZFServiceDialog::onBtnBrowseOutputClicked()
{
