...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_MainWindow3D_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_MainWindow3D_t qt_meta_stringdata_MainWindow3D = {
    {
QT_MOC_LITERAL(0, 0, 12) // "MainWindow3D"
...
QT_INIT_METAOBJECT const QMetaObject MainWindow3D::staticMetaObject = { {
    QMetaObject::SuperData::link<QMainWindow::staticMetaObject>(),
    qt_meta_stringdata_MainWindow3D.data,
    qt_meta_data_MainWindow3D,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *MainWindow3D::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_MainWindow3D.stringdata0))
