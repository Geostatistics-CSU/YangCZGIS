...
#include <memory>
#include "../../../../src/service/CubeDialog.h"
...
QT_MOC_LITERAL(1, 11, 8), // "SendCube"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 5), // "index"
QT_MOC_LITERAL(4, 27, 4), // "size"
QT_MOC_LITERAL(5, 32, 13), // "onActionInput"
QT_MOC_LITERAL(6, 46, 15), // "onActionConfirm"
QT_MOC_LITERAL(7, 62, 14) // "onActionCancel"

    },
    "CubeDialog\0SendCube\0\0index\0size\0"
    "onActionInput\0onActionConfirm\0"
    "onActionCancel"
};
...
void CubeDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<CubeDialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->SendCube((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< double(*)>(_a[2]))); break;
        case 1: _t->onActionInput(); break;
        case 2: _t->onActionConfirm(); break;
        case 3: _t->onActionCancel(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (CubeDialog::*)(int , double );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CubeDialog::SendCube)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject CubeDialog::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_CubeDialog.data,
    qt_meta_data_CubeDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void CubeDialog::SendCube(int _t1, double _t2)
{
