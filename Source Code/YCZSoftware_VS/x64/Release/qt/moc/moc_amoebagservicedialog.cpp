/****************************************************************************
** Meta object code from reading C++ file 'amoebagservicedialog.h'
**
...
#error "The header file 'amoebagservicedialog.h' doesn't include <QObject>."
...
struct qt_meta_stringdata_AmoebaGServiceDialog_t {
    QByteArrayData data[24];
    char stringdata0[287];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_AmoebaGServiceDialog_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_AmoebaGServiceDialog_t qt_meta_stringdata_AmoebaGServiceDialog = {
    {
QT_MOC_LITERAL(0, 0, 20), // "AmoebaGServiceDialog"
...
QT_MOC_LITERAL(23, 279, 7) // "onClose"
    ...
    "AmoebaGServiceDialog\0sendPyParams\0\0"
...
static const uint qt_meta_data_AmoebaGServiceDialog[] = {
...
void AmoebaGServiceDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<AmoebaGServiceDialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (AmoebaGServiceDialog::*)(QList<double> , QList<ObPtXYZ> , double , QString , int , bool , QString , int , double , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AmoebaGServiceDialog::sendPyParams)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (AmoebaGServiceDialog::*)(QString , bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AmoebaGServiceDialog::getOutPath)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (AmoebaGServiceDialog::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AmoebaGServiceDialog::begin)) {
                *result = 2;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject AmoebaGServiceDialog::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_AmoebaGServiceDialog.data,
    qt_meta_data_AmoebaGServiceDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
const QMetaObject *AmoebaGServiceDialog::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *AmoebaGServiceDialog::qt_metacast(const char *_clname)
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_AmoebaGServiceDialog.stringdata0))
        return static_cast<void*>(this);
    return QDialog::qt_metacast(_clname);
}

int AmoebaGServiceDialog::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
...
// SIGNAL 0
void AmoebaGServiceDialog::sendPyParams(QList<double> _t1, QList<ObPtXYZ> _t2, double _t3, QString _t4, int _t5, bool _t6, QString _t7, int _t8, double _t9, int _t10)
{
...
// SIGNAL 1
void AmoebaGServiceDialog::getOutPath(QString _t1, bool _t2)
{
...
// SIGNAL 2
void AmoebaGServiceDialog::begin(QString _t1)
{
